        ...
        <div className="flex flex-wrap -m-2">
          <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
            <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
              <img alt="team" className="w-16 h-16 mr-4" src="https://websiteapi.zirveyazilim.net/uploads/zirve_ticari_cf0043f5ee.svg" />
          ...
          <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
            <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
              <img alt="team" className="w-16 h-16 mr-4" src="https://websiteapi.zirveyazilim.net/uploads/zirve_uretim_6c8c99446f.svg" />
              <div className="flex-grow">
          ...
          <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
            <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
              <img alt="team" className="w-16 h-16 mr-4" src="https://websiteapi.zirveyazilim.net/uploads/zirve_finansman_132bf406d6.svg" />
              <div className="flex-grow">
          ...
          <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
            <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
              <img alt="team" className="w-16 h-16 mr-4" src="https://websiteapi.zirveyazilim.net/uploads/zirve_muhasebe_f8e6c37bae.svg" />
              <div className="flex-grow">
          ...
          <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
            <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
              <img alt="team" className="w-16 h-16 mr-4" src="https://websiteapi.zirveyazilim.net/uploads/zirve_bordro_27c5cfa22c.svg" />
              <div className="flex-grow">
          ...
          <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
            <div className="h-full flex items-center border-gray-200 border rounded-lg">
              <img alt="team" className="w-16 h-16 mr-4" src="https://websiteapi.zirveyazilim.net/uploads/zirve_e-fatura_d4e2165cca.svg" />
              <img alt="team" className="w-16 h-16 mr-4" src="https://websiteapi.zirveyazilim.net/uploads/zirve_e-arsiv-fatura_176f1c084c.svg" />
          ...
          <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
            <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
              <img alt="team" className="w-16 h-16 mr-4" src="https://websiteapi.zirveyazilim.net/uploads/zirve_e-smm_1768ed1b1d.svg" />
              <div className="flex-grow">
          ...
          <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
            <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
              <img alt="team" className="w-16 h-16 mr-4" src="https://websiteapi.zirveyazilim.net/uploads/e-Mustahsil_44f5310a9b.svg" />
              <div className="flex-grow">
